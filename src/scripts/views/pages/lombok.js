const lombok = {
    ...
    <div class="wisata">
        <div class="container-wisata">
            <div class="image-wisata">
                <img src="./lombok/pantai-kuta-2.jpeg" alt="Pantai Kuta" />
                <h3>Pantai Kuta</h3>
                <p>Destinasi</p>
            ...
            <!-- Tambahkan konten wisata lainnya di sini -->
        </div>
    </div>
    ...
    <div class="wisata">
        <div class="container-wisata">
            <div class="image-wisata">
                <img src="./lombok/pantai-kuta-1.jpeg" alt="Pantai Kuta" />
                <h3>Pantai Kuta</h3>
                <p>Destinasi</p>
                <div class="rating">Rating: 4.3</div>
            </div>
    ...
    <div class="wisata">
        <div class="container-wisata">
            <div class="image-wisata">
                <img src="./lombok/pantai-kuta-3.jpeg" alt="Pantai Kuta" />
                <h3>Pantai Kuta</h3>
                <p>Destinasi</p>
                <div class="rating">Rating: 4.3</div>
            </div>
